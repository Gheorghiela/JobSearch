                ...
                <form action="{{ route('search') }}" class="serach-form-area">
                    <div class="row justify-content-center form-wrap">
                        <div class="col-lg-4 form-cols">
                            <input type="text" class="form-control" name="search" placeholder="Cauta job">
                        </div>
                        ...
                        <div class="col-lg-2 form-cols">
                            <button type="submit" class="btn btn-info">
                              <span class="lnr lnr-magnifier"></span> Cauta
                            </button>
                        </div>
                    </div>
                </form>
                <p class="text-white"> <span>Cauta dupa categorii:</span>
...
<div class="col-lg-8 post-list">
    ...
    <a class="text-uppercase loadmore-btn mx-auto d-block" href="{{ route('jobs.index') }}">Mai mult</a>
</div>
@endsection
